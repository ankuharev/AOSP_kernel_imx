...
#ifdef CONFIG_IWG15
/* IWG15: Resistive Touch: Workaround for Calibration issue */
#define MAX11801_MAX_X                  4000
#define MAX11801_MAX_Y                  3830

#define MAX11801_MIN_X                  100
#define MAX11801_MIN_Y                  120
#else
...
#ifdef CONFIG_IWG15
			/* IWG15: Resistive Touch: Workaround for Calibration issue */
			y = MAX11801_MAX_Y - y + MAX11801_MIN_Y;
#else
...
#ifdef CONFIG_IWG15
	/* IWG15: Resistive Touch: Workaround for Calibration issue */
	input_set_abs_params(input_dev, ABS_X, MAX11801_MIN_X, MAX11801_MAX_X, 0, 0);
	input_set_abs_params(input_dev, ABS_Y, MAX11801_MIN_Y, MAX11801_MAX_Y, 0, 0);
#else
