...
static ssize_t iwg15_backlight_backlight_ctrl_state(struct device *dev,
...
static ssize_t iwg15_backlight_backlight_ctrl(struct device *dev,
...
static DEVICE_ATTR(bklight_enable, S_IWUSR | S_IRUGO, iwg15_backlight_backlight_ctrl_state, iwg15_backlight_backlight_ctrl);
...
/* 
 * iwg15_backlight_probe - Probe method for the iwg15 backlight contolling GPIOs.
 * @np: pointer to device tree node
 *
 * This function probes the iwg15 backlight control GPIOs in the device tree. It request GPIOs
