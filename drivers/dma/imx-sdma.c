...
#if defined (CONFIG_IWG15) && defined (CONFIG_SND_SOC_IMX_ALC5610)
                /* IWG15: AUDIO: Fix for AC97 AUDIO IN */
                per_2_emi = sdma->script_addrs->ssiapp_2_mcu_ac97_addr;
#else
                per_2_emi = sdma->script_addrs->app_2_mcu_addr;
#endif
                emi_2_per = sdma->script_addrs->mcu_2_app_addr;
...
#if defined (CONFIG_IWG15)  && defined (CONFIG_SND_SOC_IMX_ALC5610)
                /* IWG15: AUDIO: Fix for AC97 AUDIO IN */
                per_2_emi = sdma->script_addrs->ssishp_2_mcu_ac97_addr;
#else
...
#ifdef CONFIG_IWG15
/* IWG15: AUDIO: Fix for AC97 AUDIO IN */
#define SDMA_SCRIPT_ADDRS_ARRAY_SIZE_V1	43
#else
